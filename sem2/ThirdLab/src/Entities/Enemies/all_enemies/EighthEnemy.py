...
class EighthEnemy(EnemyI):
    
    def __init__(self, *groups, bm,pos,data):
        self.import_assets('./graphics/enemies/eighth')
        self.animation_index = 0
        super().__init__(*groups, bm=bm,img=self.moving_animations[self.animation_index],data=data,score=data['enemy']['SCORES_EIGHTH_ENEMY'])     
