...
class GUI(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.to_the_start = tk.Button(navigation_frame,text="start",command=self.controller.start_page)
        self.to_the_start.pack(side=tk.LEFT,padx=5)
        self.prev_button = tk.Button(navigation_frame,text="Prev",command=self.controller.prev_page)
        self.prev_button.pack(side=tk.LEFT,padx=5)
        navigation_frame.pack(pady=10)
        self.page_label = tk.Label(navigation_frame,text="1")
        self.page_label.pack(side=tk.LEFT,padx = 5)
        self.next_button = tk.Button(navigation_frame,text="Next",command=self.controller.next_page)
        self.next_button.pack(side=tk.LEFT,padx=5)
        self.to_the_finish = tk.Button(navigation_frame,text="end",command=self.controller.end_page)
